	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_network_request_listener = new RequestNetwork.RequestListener() {
			...
			public void onResponse(String _param1, String _param2, HashMap<String, Object> _param3) {
				...
				map.put("title", "Booking Cancelled");
				map.put("date", String.valueOf((long)(cal.getTimeInMillis())));
				map.put("message", "Booking has been cancelled. Click to see details");
				map.put("seen", "true");
				map.put("getPost", getIntent().getStringExtra("getPost"));
				map.put("uid", FirebaseAuth.getInstance().getCurrentUser().getUid());
				map.put("status", "canceled");
				notification.child(getIntent().getStringExtra("uid").concat("/".concat(getIntent().getStringExtra("getPost")))).updateChildren(map);
	...
	private void initializeLogic() {
		if (getIntent().getBooleanExtra("dialogTheme",true)) {
			...
			
			{
				...
				SketchUi.setColor(0xFFFFFFFF);SketchUi.setCornerRadius(d*30);
				_simpleRiffle(back_btn);
				_simpleRiffle1(cancel_btn);
