...
public class RecommendationsActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		...
		_riffleEffect("#f5f5f5", search);
		_ImageColor(back, "#176b87");
		_ImageColor(search, "#176b87");
	...
	public class Recyclerview1Adapter extends RecyclerView.Adapter<Recyclerview1Adapter.ViewHolder> {
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			if (_data.get((int)_position).containsKey("rating")) {
				rating.setText("⭐ ".concat(String.valueOf(Double.parseDouble(_data.get((int)(_data.size() - 1) - _position).get("rating").toString()))));
			}
			else {
