...
public class ViewPhotoActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear_box = findViewById(R.id.linear_box);
	}
	
	private void initializeLogic() {
		
		pv = new PhotoView(this);
		linear_box.addView(pv);
		pv.setLayoutParams(new LinearLayout.LayoutParams(android.widget.LinearLayout.LayoutParams.MATCH_PARENT, android.widget.LinearLayout.LayoutParams.MATCH_PARENT));
		Glide.with(getApplicationContext()).load(Uri.parse(getIntent().getStringExtra("link"))).into(pv);
	}
	PhotoView pv;
	{
	}
